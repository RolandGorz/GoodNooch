        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (edit.getText().length() == 0) {
                    ...
                    stats.calories = Integer.parseInt(edit.getText().toString());
                }
                edit = (EditText)findViewById(R.id.fat_number);
                if (edit.getText().length() == 0) {
                    stats.fat = 0;
                } else {
                    stats.fat = Integer.parseInt(edit.getText().toString());
                }
                edit = (EditText)findViewById(R.id.sat_fat_number);
                if (edit.getText().length() == 0) {
                    stats.sat_fat = 0;
                } else {
                    stats.sat_fat = Integer.parseInt(edit.getText().toString());
                }
                edit = (EditText)findViewById(R.id.trans_fat_number);
                if (edit.getText().length() == 0) {
                    stats.trans_fat = 0;
                } else {
                    stats.trans_fat = Integer.parseInt(edit.getText().toString());
                }
                edit = (EditText)findViewById(R.id.cholesterol_number);
                if (edit.getText().length() == 0) {
                    stats.cholesteral = 0;
                } else {
                    stats.cholesteral = Integer.parseInt(edit.getText().toString());
                }
                edit = (EditText)findViewById(R.id.sodium_number);
                if (edit.getText().length() == 0) {
                    stats.sodium = 0;
                } else {
                    stats.sodium = Integer.parseInt(edit.getText().toString());
                }
                edit = (EditText)findViewById(R.id.carbohydrate_number);
                if (edit.getText().length() == 0) {
                    stats.carbs = 0;
                } else {
                    stats.carbs = Integer.parseInt(edit.getText().toString());
                }
                edit = (EditText)findViewById(R.id.fiber_number);
                if (edit.getText().length() == 0) {
                    stats.fiber = 0;
                } else {
                    stats.fiber = Integer.parseInt(edit.getText().toString());
                }
                edit = (EditText)findViewById(R.id.sugar_number);
                if (edit.getText().length() == 0) {
                    stats.sugar = 0;
                } else {
                    stats.sugar = Integer.parseInt(edit.getText().toString());
                }
                edit = (EditText)findViewById(R.id.protein_number);
                if (edit.getText().length() == 0) {
                    stats.protein = 0;
                } else {
                    stats.protein = Integer.parseInt(edit.getText().toString());
                }
                fileSystem();
            }
        });
